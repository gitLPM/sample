...
class OrdersController extends Controller
{
    ...
    public function __construct(
         ...
         *
         * paypal omnipay config
         *
         * https://github.com/thephpleague/omnipay
         *
         * https://github.com/payproNL/omnipay-paypro#readme
         *
         * *****************************/
    ...
    case 'sandbox':
        ...
        break;
        endswitch;
        $username = config('paypal.' . $mode . '.username');
        $password = config('paypal.' . $mode . '.password');
        $signature = config('paypal.' . $mode . '.secret');

        $this->gateway = Omnipay::create($payment_method);
        $this->gateway->setUsername($username);
        $this->gateway->setPassword($password);
        $this->gateway->setSignature($signature);
        $this->gateway->setTestMode($testmode); // here 'true' is for sandbox. Pass 'false' when go live
